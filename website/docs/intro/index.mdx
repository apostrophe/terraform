...
Terraform creates and manages resources on cloud platforms and other services by providing a declarative IaaC configuration language and an extensive library of bundled APIs (called [providers](https://developer.hashicorp.com/terraform/language/providers)) through which that infrastructure is created and modified.
